...
function LevelAppI() {
  ...
  const getDetails = () => {
    axios.get(`http://localhost:3333/showLevelIRequests`).then((res) => {
      console.log("res: ", res);
  ...
  return (
    <div>
      <h2>Account Entitlement Level I</h2>
              ...
              <div className="col">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    makeEnrollment(values.userId, "Approved", 1);
                  }}
                >
                  Approve
                </button>
                ...
                <button
                  ...
                  onClick={(e) => {
                    ...
                    console.log("====================================");
                    makeEnrollment(values.userId, "Reject", 1);
                  }}
                >
                  Reject
                </button>
