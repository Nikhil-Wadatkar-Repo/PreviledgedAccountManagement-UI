...
function LevelAppII() {
  ...
  const getDetails = () => {
    axios.get(`http://localhost:3333/showLevelIIRequests`).then((res) => {
      console.log("res: ", res);
  ...
  return (
    <div>
      <h2>Account Entitlement Level II</h2>
              ...
              <div className="col">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    makeEnrollment(values.userId, "Approved", 2);
                  }}
                >
                  Approve
                </button>
                ...
                <button
                  ...
                  onClick={(e) => {
                    ...
                    console.log("====================================");
                    makeEnrollment(values.userId, "Reject", 2);
                  }}
                >
                  Reject
                </button>
